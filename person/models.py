...
class Address(models.Model):
    ...
    neighbood = models.CharField(verbose_name='Complemento', max_length=100, blank=True, null=True)
    city = models.CharField(verbose_name='Complemento', max_length=100)
    state = models.CharField(verbose_name='Complemento', max_length=2)
